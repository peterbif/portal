        ...
        <div class="row">
            <div class="col-lg-12 showResult">
                ...
                <table class="table table-bordered" id="myTable">
                    <tbody>
                        <tr>
                            <td colspan="12" style="background-color: darkgray"> <?php require('header2.php') ?></td>
                        </tr>
                        <tr>
                            <td colspan="12" style="background-color: #000000">
                                <h6 style="color: #ffffff; font-size: 17px; text-align: center;">APPLICATION FORM FOR ENTRY INTO THE <?php echo  @$record_res2['school']; ?>, UCH, IBADAN </h6>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="12"><span style="font-size: 15px; font-weight: bolder;">Importance Notice</span><br /> <span style="text-transform: none">The Course is for a period of three years after which candidates will be presented for both Hospital Final Examination and the Nursing and Midwifery Council of Nigeria Final Examination to qualify as a General Nurse and be eligible to become a Registered Nurse (RN).</span> </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4">EMAIL ADDRESS: <strong><?php echo  @$record_pin['email']; ?></strong></td>
                        ...
                        <tr>
                            <td colspan="12">
                                <h3 align="left" style="font-size: 14px;"><strong>3. ACADEMIC RECORDS</strong></h3>
                            </td>
                        </tr>

                        <tr>
                            <th colspan="5">Institution Attended with Dates(From Primary School)</th>
                            <th colspan="2">Period <br /> (From-To)</th>
                            <th colspan="2">Qualification Obtained</th>
                        </tr>
                        <?php $sn = 1;
                        do {
