        ...
        <div class="row">
            <div class="col-lg-12 showResult">
                ...
                <table class="table table-bordered" id="myTable">
                    <tbody>
                        <tr>
                            <td colspan="12" style="background-color: #000000" align="center"> <span style="color: #ffffff; font-size: 20px; text-align: center;"> <?php echo  @$record_res2['school']; ?> <br /><span style="font-size: 17px">UNIVERSITY COLLEGE HOSPITAL <br /> IBADAN, NIGERIA</span></td>
                        </tr>

                        <tr style="border-collapse: collapse;">
                            <td colspan="3" align="left" style="border-right: 0px"><img src="uploads/<?php echo @$result_logo['logo']; ?>" class="img-rounded" width="120px" height="100px" /></td>
                            ...
                            <td colspan="3"><img align="right" src="thumbs/<?php echo @$result_pass['capture']; ?>" class="img-rounded" width="120px" height="100px" /></span></td>
                        </tr>

                        <tr>
                            <td colspan="12" align="center"><span style="font-size: 15px; font-weight: bolder;">ENTRANCE EXAMINATION / INTERVIEW ADMISSION CARD</span><br /><span style="font-size: 12px;text-transform: none">Bring this card to the examination and interview venues</span> </td>
                        </tr>

                        <tr>
                            <td colspan="2">SURNAME: <strong><?php echo @$result_bio['bsurname'] ?></strong></td>
                            <td colspan="2">FIRST NAME: <strong><?php echo  @$result_bio['bfirstname']; ?></strong></td>
                            <td colspan="2">Othername: <strong><?php echo @$result_bio['bothername']; ?></strong></td>
                            <td colspan="2">MAIDEN NAME: <strong><span style="text-transform: capitalize"><?php echo @$result_bio['maiden_name']; ?></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="4">SEX: <strong><span style="text-transform: capitalize"><?php echo @$result_bio['gender']; ?></span></strong></td>
                            <td colspan="2">AGE: <strong><span style="text-transform: capitalize"><?php @$age =  $db->age($result_bio['date_of_birth']);
                                                                                                    echo @$age . 'yrs'; ?></span></strong></td>
                            <td colspan="3">PHONE NO: <strong><?php echo @$record_pin['phone_no']; ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="12">POSTAL/CONTACT ADDRESS: <strong><span style="text-transform: capitalize"><?php echo @$result_con['street_add2']; ?></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="12">EMAIL ADDRESS: <strong><span style="text-transform: lowercase"><?php echo  @$record_pin['email']; ?></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="12">PROGRAM: <strong><?php echo $recordset_prog2['program']; ?></strong> <strong><span style="text-transform: capitalize"></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="6">CANDIDATE'S SIGNATURE: <strong><span style="text-transform: capitalize"></span></strong></td>
                            <td colspan="4">DATE: <strong><span style="text-transform: capitalize"></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="2">EXAMINATION DATE: <strong><span style="text-transform: capitalize"></span></strong></td>
                            <td colspan="2">TIME: <strong><span style="text-transform: capitalize"></span></strong></td>
                            <td colspan="6">EXAM. VENUE: <strong></strong></td>
                        </tr>
