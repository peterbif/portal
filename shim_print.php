                ...
                <table class="table table-bordered" id="myTable">
                    <tbody>
                        ...
                        <tr style="border-collapse: collapse;">
                            <td id="form_no" align="center" colspan="2"><span style="font-size: 16px;">FORM NO</span> <br /><br /><span style="font-size: 20px; font-weight: bolder"><?php echo @$record_res2['form_no']; ?></span></td>
                            <td colspan="3" align="center" style="border-right: 0px"><img src="uploads/<?php echo @$result_logo['logo']; ?>" class="img-rounded" width="120px" height="100px" /></td>
                            <td colspan="6"><img align="right" src="thumbs/<?php echo @$result_pass['capture']; ?>" class="img-rounded" width="120px" height="100px" /></span></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="4">AGE: <strong><span style="text-transform: capitalize"><?php @$age =  $db->age($db->orderDate($result_bio['date_of_birth']));
