    ...
    <div class="row">
        <div class="col-lg-12 showResult">
            ...
            <table class="table table-bordered" id="myTable">
              ...
              <?php if($record_res2['school_id'] == 11){?>
                <tr>
                ...
                <tr style="border-collapse: collapse;">
                    ...
                    <td colspan="6"><img align="right" src="uploads/<?php echo @$result_pass['capture']; ?>" class="img-rounded" width="120px" height="100px" /></span></td>
                </tr>
                <?php  } ?>


                <?php if($record_res2['school_id'] == 3){ ?>
              ...
              <?php if($record_res2['school_id'] == 11){ ?>
                  <tr>
                      <td colspan="12">
                          <h3 align="left" style="font-size: 14px;"><strong>Additional Qualification(s)</strong></h3>
                      </td>
                  </tr>
